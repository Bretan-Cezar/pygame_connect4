...
class TestService(unittest.TestCase):
    ...
    def execute(self):
        ...
        test_service.player_push_to_col(1)
        test_service.player_push_to_col(2)
        test_service.player_push_to_col(4)
        ...
        test_service.player_push_to_col(5)
        test_service.player_push_to_col(5)
        test_service.player_push_to_col(5)
        test_service.computer_push_to_col()
        ...
        test_service.player_push_to_col(3)
        test_service.player_push_to_col(3)
        test_service.player_push_to_col(3)
        test_service.player_push_to_col(3)
        ...
        with self.assertRaisesRegex(InvalidColumnException, 'Entered column is out of bounds!'):
            test_service.player_push_to_col(6)
